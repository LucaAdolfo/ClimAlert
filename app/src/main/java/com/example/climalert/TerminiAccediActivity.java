...
public class TerminiAccediActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_termini_accedi);
        ...
        btnIndietro.setOnClickListener(view -> {
            Intent intent = new Intent(TerminiAccediActivity.this, RegistratiActivity.class);
